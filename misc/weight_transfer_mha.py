...
# Function to transfer weights from PyTorch to xFormer
...
def transfer_weights(pytorch_model, xformers_model):
    ...
    weight_map = {
        ...
        'attn.out_proj.bias': 'proj.bias',
        'attn.out_proj.weight': 'proj.weight',
    }
...
with torch.no_grad():
    ...
    print("Output values: ", torch.sum(pytorch_output), torch.sum(xformers_output))
